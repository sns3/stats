...
{
    static TypeId tid =
        TypeId("ns3::StatsThroughputHelper")
...
void
StatsThroughputHelper::RxCallback(Ptr<const Packet> packet, const Address& from)
{
...
{
    static TypeId tid = TypeId("ns3::StatsAppThroughputHelper").SetParent<StatsThroughputHelper>();
    return tid;
}
